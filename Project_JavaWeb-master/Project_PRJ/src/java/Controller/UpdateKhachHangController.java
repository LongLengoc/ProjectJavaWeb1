...
public class UpdateKhachHangController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Lay thong tin khach hang can update
            request.setAttribute("kh", kh.select1(maKH));
            ...
            if (request.getParameter("capnhat") != null) {
                ...
                kh.update(Makh, Tenkh, gender, diachi, DOB);
                request.setAttribute("UpdateKHSuccess", "Update Khach Hang successfully");
